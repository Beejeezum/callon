...
- OpenAI Responses/structured outputs: https://platform.openai.com/docs/quickstart and https://platform.openai.com/docs/guides/structured-outputs
- WhatsApp Business Platform documentation and policy: https://developers.facebook.com/docs/whatsapp/ and https://business.whatsapp.com/policy
- Codex/AGENTS.md: https://openai.com/codex/ and current Codex documentation

Do not treat this list as legal advice or a version lock. Task 00 records exact dependency/provider versions selected at implementation time.
