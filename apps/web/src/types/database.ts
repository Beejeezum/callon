...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      change_membership_role: { Args: { p_input: Json }; Returns: string };
      ...
      create_manual_resource: { Args: { p_input: Json }; Returns: string };
      ...
      provision_circle: { Args: { p_input: Json }; Returns: string };
      publish_ask: {
      ...
      revoke_circle_invite: { Args: { p_input: Json }; Returns: string };
      ...
      update_resource_settings: { Args: { p_input: Json }; Returns: string };
    };
    Enums: {
      ask_status:
        | "draft"
